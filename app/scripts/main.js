//(function(){
  ...
  function restart() {
      ...
      function drawCurves(){
        ...
        $('#save-curve').click(function(){
          ...
          templateCurves.push(jQuery.extend({}, current));
    ...
    if(jQuery.isEmptyObject(RESULTS)){
      ...
      for (var prop in data.results) {
        ...
        if(!Array.isArray(RESULTS[prop])){
          ...
          resultsString     += "<br/> MWL: " + RESULTS[prop].result["Value"];
          resultsString     += "<br/> DOT: " + RESULTS[prop].result["DOT"];
          ...
          for(var i =0; i < RESULTS[prop].length; i++){
            ...
            resultsString     += "<br/> MWL: " + RESULTS[prop][i].result["Value"];
            resultsString     += "<br/> DOT: " + RESULTS[prop][i].result["DOT"];
  ...
  function getArgNames(index){
    ...
    for(var i = 0; i < index.length; i++){
      ...
      result += thing.name + "      (DOT:" + RESULT_NODES[index[i]]["degreeOfTruth"] +",       MWL:" + RESULT_NODES[index[i]]["total"] + "), <br/>";
    }
